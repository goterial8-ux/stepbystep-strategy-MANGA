    ...
    if (saved) {
      try {
        ...
        if (!parsed.promptRegistry) {
          ...
          if (!parsed.promptRegistry.globalRulesPrompt.includes('ЗАПРЕТ НА СКУКУ') || !parsed.promptRegistry.globalRulesPrompt.includes('УНИВЕРСАЛЬНОЕ ПРАВИЛО: ЖИВОЙ РАССКАЗЧИК ОТ ПЕРВОГО ЛИЦА')) {
